...
- MANUAL P01: 각 축의 ENABLE 옆에 DISABLE 버튼을 배치했습니다.
- P04 USB CAN: 1초 간격 상태 확인·재연결, 장치 고유번호 저장, 재접속 시 권한/절전 규칙을 적용합니다.
- 재연결은 통신만 복구하며 이전 이동이나 호밍을 자동 실행하지 않습니다.

[USB CAN 재연결 설정](docs/P04_USB_RECONNECT.md)
